          ...
          <CardContent className="p-0">
              ...
              <table className="w-full min-w-[900px] text-sm">
                <thead className="sticky top-0 bg-gradient-to-b from-slate-50/70 to-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/70">
                  <tr className="text-right">
                    ...
                    <th className="px-4 py-3 font-medium">الخروج</th>
                    ...
                    <th className="px-4 py-3 font-medium">الإضافي</th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap">
                          {isHoliday ? (
                            <Badge className="rounded-full bg-purple-100 text-purple-900 hover:bg-purple-100">إجازة</Badge>
                          ) : (
                            statusBadge(status)
                          )}
                        </td>
                            ...
                            <SheetContent side="left" className="w-full sm:max-w-xl">
                              ...
                              <div className="mt-6 grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-2">
                                  ...
                                  <div className="mt-2">{isHoliday ? (<Badge className="rounded-full bg-purple-100 text-purple-900 hover:bg-purple-100">إجازة</Badge>) : statusBadge(status)}</div>
                                </div>
                                {r.notes && (
                                  <div className="col-span-2">
            ...
            <div className="md:hidden divide-y divide-neutral-200">
              {rows.map((r, idx) => {
                ...
                const isHoliday = !!(r.notes && (r.notes.includes("عطلة") || r.notes.includes("إجازة")));
                return (
                  <div key={r.id} className={cn("p-4", isHoliday && "bg-gradient-to-r from-violet-50 to-white")}>
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div>
                        {isHoliday ? (
                          <Badge className="rounded-full bg-purple-100 text-purple-900 hover:bg-purple-100 text-xs">إجازة</Badge>
                        ) : (
                          statusBadge(status)
                        )}
                      </div>
